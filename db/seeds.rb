...
user_donator = UserBloodDonator.create! :name => 'Doador O-', :email => 'mathiasvoelcker@gmail.com', :password => '123456', :password_confirmation => '123456', :cpf => '14432678912', :blood_type => 'O-', :notification => false, :genre => 'm', :last_donation => DateTime.now - 100.days
