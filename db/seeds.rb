...
user_bank = UserBloodBank.create! :name => 'Pedrao dos Banco', :email => 'pedrao@admin.com', :password => '123456', :password_confirmation => '123456', :cnpj => '12345678912345', :actived => false, :address => "Av. Ipiranga, 6690"
user_bank_actived = UserBloodBank.create! :name => 'Pedrao dos Banco', :email => 'pedraoativado@admin.com', :password => '123456', :password_confirmation => '123456', :cnpj => '12345678912311', :actived => true, :address => "Av. Ipiranga, 6690"
