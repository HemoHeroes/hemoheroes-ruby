...
user_donator = UserBloodDonator.create! :name => 'Pedrao dos Login', :email => 'cristianferreira_gks@hotmail.com', :password => '123456', :password_confirmation => '123456', :cpf => '12345678912', :blood_type => 'A+', :notification => true, :genre => 'm', :last_donation => DateTime.now - 100.days
user_donator = UserBloodDonator.create! :name => 'Doador A+', :email => 'lucasgaspari1998@gmail.com', :password => '123456', :password_confirmation => '123456', :cpf => '12345678332', :blood_type => 'A+', :notification => true, :genre => 'm', :last_donation => DateTime.now - 100.days
...
user_donator = UserBloodDonator.create! :name => 'Doador B-', :email => 'marlonfurtado.rs@gmail.com', :password => '123456', :password_confirmation => '123456', :cpf => '12366678912', :blood_type => 'B-', :notification => true, :genre => 'm', :last_donation => DateTime.now - 100.days
