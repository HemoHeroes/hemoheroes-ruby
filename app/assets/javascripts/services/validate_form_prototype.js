...
//
//     if(!invalidInput){
//       var buttonRegisterSimpleDonator = document.querySelector('.js-validateButtonDonator');
//       buttonRegisterSimpleDonator.classList.remove('is-disabled');
//       buttonRegisterSimpleDonator.classList.add('is-actived');
//     }else{
//       var buttonRegisterSimpleDonator = document.querySelector('.js-validateButtonDonator');
//       buttonRegisterSimpleDonator.classList.remove('is-actived');
